    ...
    <div class="filter-form">
      <div class="filter-row">
        <div class="filter-item">
          ...
          <input type="number" id="completedFlowIdFilter" v-model="filters.id" placeholder="请输入ID">
        </div>
        <div class="filter-item">
          <label for="completedFlowFlowIdFilter">审批流ID</label>
          <input type="number" id="completedFlowFlowIdFilter" v-model="filters.approval_flow_id" placeholder="请输入审批流ID">
        </div>
        <div class="filter-item">
          <label for="completedFlowTypeFilter">审批流类型</label>
          <select id="completedFlowTypeFilter" v-model="filters.approval_flow_type_id">
...
import { getCompletedFlows, getApprovalFlowDetail } from '../../api/approval'
  ...
  setup(props) {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const response = await getCompletedFlows(params)
        flows.value = response.data.data.completed_flows || []
      } catch (error) {
        console.error('获取处理完成列表失败:', error)
